...
![Perfil e dados de login](../../images/settings/08.png)
...
![Alteração de foto de perfil](../../images/settings/09.png)
...
![Preferências do usuário](../../images/settings/10.png)
...
![Filtros padrão](../../images/settings/13.png)
...
![Configurações de negociações](../../images/settings/14.png)
