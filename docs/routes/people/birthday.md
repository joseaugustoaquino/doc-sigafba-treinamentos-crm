...
![Aniversariante](../../images/people/a1.png)

Ao clicar no botão de envio de mensagens, é exibida a mensagem padrão de [_configurações_](../../routes/settings/settings.md/#configurar-usuário), permitindo ao usuário editar e enviar algo específico para aquela pessoa.

![Aniversariante](../../images/people/a2.png)

**Observação:** A exibição das informações dentro da pessoa é um espelho da tela ao lado.  
Para mais detalhes, consulte [_Informações_](./people.md/#informações).
